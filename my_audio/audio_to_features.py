...
# both map options supposedly facilitate tqdm: https://stackoverflow.com/questions/41920124/multiprocessing-use-tqdm-to-display-a-progress-bar
#but the imap version doesn't seem to work
# r = process_map(edit_convert_save_track, all_iterables[:21], max_workers=4, chunksize=5)

# with Pool(10) as p:
#     r = tqdm(p.imap(edit_convert_save_track, all_iterables[:20], chunksize=20))
